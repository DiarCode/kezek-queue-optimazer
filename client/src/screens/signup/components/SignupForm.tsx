...
export const SignupForm = () => {
  ...
  return (
    ...
    >
      <div>
        <Label required text="First Name" className="mb-2" />
        <InputField
          placeholder="Carla"
          type="text"
      ...
      <div>
        <Label required text="Second Name" className="mb-2" />
        <InputField
      ...
      <div>
        <Label required text="Date of birth" className="mb-2" />
        <InputField
      ...
      <div>
        <Label required text="Email" className="mb-2" />
        <InputField
