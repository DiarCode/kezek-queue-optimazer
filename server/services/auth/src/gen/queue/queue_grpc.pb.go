...
func (c *queueServiceClient) CreateQueue(ctx context.Context, in *CreateQueueRequest, opts ...grpc.CallOption) (*Queue, error) {
	out := new(Queue)
	err := c.cc.Invoke(ctx, "/queuepb.QueueService/CreateQueue", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queueServiceClient) GetQueueById(ctx context.Context, in *GetQueueByIdRequest, opts ...grpc.CallOption) (*Queue, error) {
	out := new(Queue)
	err := c.cc.Invoke(ctx, "/queuepb.QueueService/GetQueueById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _QueueService_CreateQueue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/queuepb.QueueService/CreateQueue",
	}
...
func _QueueService_GetQueueById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/queuepb.QueueService/GetQueueById",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueueServiceServer).GetQueueById(ctx, req.(*GetQueueByIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _QueueService_InsertCandidateToQueue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(QueueServiceServer).InsertCandidateToQueue(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/queuepb.QueueService/InsertCandidateToQueue",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueueServiceServer).InsertCandidateToQueue(ctx, req.(*InsertCandidateToQueueRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var QueueService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "queuepb.QueueService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _QueueService_InsertCandidateToQueue_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "protos/queue/queue.proto",
}
